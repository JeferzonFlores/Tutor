                    ...
                    <ul class="nav nav-pills nav-fill p-1" role="tablist">
                        ...
                        <li class="nav-item" style="text-align: left;">
                            <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="false">
                                ...
                                <span class="ms-1">Completado</span>
                            </a>
            ...
            <div class="row">
                <div class="col-12 col-xl-8">
                    ...
                    <div class="card z-index-2 ">
                        <form id="quizForm" action="result.html" method="post">

                            <h6 class="alert alert-success" role="alert" style="color:white">Pregunta 1: ¿Cuál es la definición correcta de una variable aleatoria?</h6>
                            ...
                            <h6 class="alert alert-danger" role="alert" style="color:white">Pregunta 2: ¿Cuál es la diferencia entre una variable aleatoria discreta y una variable aleatoria continua?</h6>
                            ...
                            <h6 class="alert alert-success" role="alert" style="color:white">Pregunta 3: ¿Cuál de las siguientes distribuciones es un ejemplo de una variable aleatoria continua?</h6>
                        ...
                        <center>
                                <div class="d-grid gap-2">
                                    <a href="{{route('avA')}}">
                                    <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#exampleModal" style="font-size: 20px;">Siguiente Lección</button>
                                    </a>
                                </div>
