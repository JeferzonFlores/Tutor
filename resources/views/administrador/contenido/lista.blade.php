                             ...
                             <div class="modal-dialog">
                                 <div class="modal-content">
                                     <div class="modal-header">
                                         <h5 class="modal-title" id="staticBackdropLabel">Resgistro de Exámen</h5>
                             ...
                             <table class="table align-items-center mb-0">
                                 <thead>
                                     <tr>
                                         ...
                                         <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="width: 250px;">Descripción</th>
                                 ...
                                 <tbody>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <p class="text-xs font-weight-bold mb-0" style="width: 280px;">{{ \Illuminate\Support\Str::limit($t->introduccion, 50, '...')}}</p>
                                         </td>
                                         <td>
                                             <div class="d-flex px-2 py-1">
                                         ...
                                         <td>
                                             ...
                                             <a href="{{ route('examenes', ['id' => $t->id]) }}">
                                                 <button type="button" class="btn btn-info">Examen</button>
                                             </a>
                                             <a href="{{ route('Contenidos', ['id' => $t->id]) }}">
                                                 <button type="button" class="btn btn-success">Contenido</button>
                                             </a>
                                         </td>
                                     </tr>
                                     @endforeach
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <div class="d-flex px-2 py-1">
                                                 ...
                                                 <div class="d-flex flex-column justify-content-center">
                                                     <h6 class="mb-0 text-sm">Cápitulo 1</h6>
                                                 </div>
                                             </div>
                                         </td>
                                         <td>
                                             <p class="text-xs font-weight-bold mb-0" style="text-align: center;">4</p>
                                         </td>
                                         <td>
                                             <p class="text-xs font-weight-bold mb-0" style="text-align: center;">2</p>
                                         </td>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <div class="d-flex px-2 py-1">
                                                 ...
                                                 <div class="d-flex flex-column justify-content-center">
                                                     <h6 class="mb-0 text-sm">Cápitulo 2</h6>
                                                 </div>
                                             </div>
                                         </td>
                                         <td>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <div class="d-flex px-2 py-1">
                                                 ...
                                                 <div class="d-flex flex-column justify-content-center">
                                                     <h6 class="mb-0 text-sm">Cápitulo 3</h6>
                                                 </div>
                                             </div>
                                         </td>
                                         <td>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <div class="d-flex px-2 py-1">
                                                 ...
                                                 <div class="d-flex flex-column justify-content-center">
                                                     <h6 class="mb-0 text-sm">Cápitulo 4</h6>
                                                 </div>
                                             </div>
                                         </td>
                                         <td>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <div class="d-flex px-2 py-1">
                                                 ...
                                                 <div class="d-flex flex-column justify-content-center">
                                                     <h6 class="mb-0 text-sm">Cápitulo 5</h6>
                                                 </div>
                                             </div>
                                         </td>
                                         <td>
