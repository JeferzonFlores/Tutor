        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <h6 class="font-weight-bolder mb-0">Asignación Materias a Docentes</h6>
                </nav>
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav justify-content-end">
                        <li>
                            ...
                            <!-- Modal de Asignación Materia-Docente -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="createAssignmentModalLabel">Asignar Materia a Docente</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <form action="{{ route('admin.materia-teacher.store') }}" method="POST">
                                            @csrf
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-danger shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Asignaciones de Materias a Docentes</h6>
                            </div>
                        </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Docente Asignado</th>
                                    ...
                                    <tbody>
                                        @forelse ($materias as $materia)
                                            @forelse ($materia->teachers as $teacher)
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0">{{ $teacher->name }} ({{ $teacher->username }})</p>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span class="text-secondary text-xs font-weight-bold">{{ $teacher->pivot->created_at->format('d/m/Y H:i') }}</span>
                                                </td>
                                                <td class="align-middle">
                                                    <form action="{{ route('admin.materia-teacher.destroy') }}" method="POST" style="display:inline-block;">
                                                        @csrf
                                                        @method('DELETE')
                                            ...
                                            @empty
                                                <!-- Opcional: Mostrar que la materia no tiene docentes asignados -->
                                            @endforelse
                                        @empty
                                        <tr>
                                            <td colspan="4" class="text-center">No hay asignaciones de materias a docentes.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
